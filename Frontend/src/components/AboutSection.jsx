...
const AboutSection = () => {
  return (
    <section className="relative lg:py-14 md:py-12 py-10 bg-gradient-to-br from-gray-50 to-white overflow-hidden">
      ...
      <div className="absolute -z-10 top-0 left-0 w-64 h-64 bg-blue-100 rounded-full -translate-y-1/2 -translate-x-1/4 opacity-50"></div>
      <div className="absolute -z-10 bottom-0 right-0 w-96 h-96 bg-blue-50 rounded-full translate-y-1/3 translate-x-1/4 opacity-70"></div>
      ...
      <div className="container mx-auto px-4 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
            <div className="bg-blue-100 p-4 rounded-xl inline-flex mb-6 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-2 group md:order-1">
            <div className="absolute inset-0 bg-gradient-to-tr from-blue-600 to-indigo-600 rounded-3xl transform rotate-4 transition-all ease-in-out duration-500 group-hover:rotate-0"></div>
            ...
            {/* Floating badges */}
            <div className="absolute top-4 -right-4 bg-white rounded-full p-3 shadow-lg z-20 border-2 border-blue-100">
              <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <div className="absolute -bottom-4 -left-4 bg-white rounded-full p-3 shadow-lg z-20 border-2 border-blue-100">
              <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="order-1 md:order-2">
            ...
            <div className="inline-flex rounded-lg shadow-lg">
              <Link to='/about' className="inline-flex group items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-lg text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all duration-300">
                Discover Our Story
