...
export default function CTASection() {
  ...
  return (
    ...
    <section className="relative w-full py-20 z-0 bg-[url('https://img.freepik.com/premium-photo/futuristic-smart-home-diverse-connected-devices-digital-icons-seamless-integration_951586-139517.jpg?uid=R183076985&ga=GA1.1.550663172.1736244937&semt=ais_hybrid&w=740')] bg-cover bg-center
 text-white text-center">
  <div className="absolute inset-0 bg-black/30 -z-10"></div>
      <div className="max-w-3xl mx-auto px-6 z-10">
        ...
        >
          <button onClick={()=>setIsOpen(!isOpen)} className="bg-white text-blue-600 font-medium px-6 py-3 rounded-xl shadow-lg hover:bg-gray-200 transition flex items-center gap-2">
            Get Quotes
          </button>
