    ...
    >
      <div className="relative overflow-hidden h-64">
        ...
        >
          ...
          >
            See Features{' '}
            <ArrowUpRight className="inline rotate-12 group-hover:rotate-0" />
          </Link>
        </div>
      </div>
...
const ProductPage = () => {
  ...
  if (status === 'loading') {
    return (
      <div className="text-xl h-[50vh] justify-center items-center flex font-medium shadow-2xl rounded p-2">
        Loading..
      </div>
    );
  }
  if (productData.length === 0) {
    return (
      <div className="text-red-600 text-lg h-[50vh] justify-center items-center flex font-medium shadow-2xl rounded p-2">
