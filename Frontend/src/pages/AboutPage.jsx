    ...
    <div className="">
      ...
      <section className="py-12 px-4 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center text-justify">
          <div>
            <h2 className="text-4xl font-bold mb-6 text-sky-600">Our Story</h2>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Vision Card */}
          <div className="bg-white backdrop-blur-sm bg-opacity-70 p-8 rounded-3xl shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-sky-200 hover:shadow-xl group">
            <div className="flex items-start justify-between mb-6">
              <div className="w-14 h-14 bg-sky-600 rounded-2xl flex items-center justify-center">
                <Lightbulb size={28} className="text-white" />
              </div>
              <div className="p-2 rounded-full bg-sky-50 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
      ...
      {/* Background elements */}
      <div className="absolute top-0 left-0 w-full h-64 bg-sky-50 opacity-70 -skew-y-6 transform -translate-y-24"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-sky-100 rounded-full blur-3xl opacity-30"></div>
      ...
      <div className="max-w-6xl mx-auto relative">
          ...
          {coreValues.map((value) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <h3 className="text-2xl font-bold mb-4 text-gray-800 group-hover:text-sky-600 transition-colors duration-300">{value.title}</h3>
        ...
        <div className="text-center mt-16">
          <p className="text-sky-600 font-medium">Driving manufacturing excellence through our core principles</p>
        </div>
      </div>
    </section>
      ...
      <section className="relative py-20 text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to='/contact' className="bg-transparent border-2 border-white text-white font-bold py-3 px-8 rounded-full hover:bg-white hover:text-sky-800 transition-colors">
              Contact Us
            </Link>
          </div>
        </div>
